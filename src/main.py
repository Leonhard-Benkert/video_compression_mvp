...
'''manual inputs'''
input_path_relative = "assets/in.avi" # todo add video file to project folder and update filename
output_path_relative = "assets/out.avi" # todo choose filename for output
